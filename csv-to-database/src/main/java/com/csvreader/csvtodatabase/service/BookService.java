...
public class BookService {
    ...
    public void getFileEncrypted() throws Exception {
        ...
        String filePath = "/Apps/csv-encrypted-file/newFile.csv";

        String downloadFilePath = "/Apps/csv-encrypted-file/data.csv";
        String filePathUpload = "/Apps/csv-encrypted-file/uploadOne.csv";

        InputStream inputStream = dbxClientV2.files().download(downloadFilePath).getInputStream();

        dbxClientV2.files().upload(filePathUpload).uploadAndFinish(inputStream);
